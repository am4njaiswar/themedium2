...
export default function Home() {
  ...
  return (
    ...
    <main className="relative w-screen h-[100dvh] overflow-hidden bg-black selection:bg-blue-500/30 flex flex-col">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-50 pb-4 md:pb-8 pt-4 bg-gradient-to-t from-black/20 to-transparent pointer-events-none">
