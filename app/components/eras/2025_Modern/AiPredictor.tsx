  ...
  return (
    ...
    >
      <button 
        ...
        className="group flex items-center gap-2 pl-2 pr-4 py-1.5 bg-linear-to-r from-purple-500/10 to-blue-500/10 border border-blue-400/20 rounded-full backdrop-blur-md hover:bg-white/5 transition-all cursor-pointer"
      >
